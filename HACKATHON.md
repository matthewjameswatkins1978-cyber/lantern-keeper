# Nebius × NVIDIA 2026 Hackathon Disclosure

## Before Nebius 2026

Lantern Keeper already contained the epistemic Source/Episode/Claim/Belief
model, perspective and provenance, correction/supersession, stale
invalidation, Context Packs, bounded Foreman foundations, logical
export/restore, LanternBench foundations, and a bounded Tethers preview.

The exact starting revisions are recorded in
[`docs/hackathon/NEBIUS_2026_BASELINE.md`](docs/hackathon/NEBIUS_2026_BASELINE.md).
